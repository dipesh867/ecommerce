   ...
   <section>
    <div className='max-w-[1400px] mx-auto md:px-10 px-7 '>
        ...
        <div className='mt-15 mx-auto w-fit'>
            <Link to='/products/all' className='bg-gradient-to-b from-orange-400 to-orange-500 text-white px-8 py-3 rounded-full font-semibold
               hover:bg-orange-600 text-lg hover:scale-105 transition-all duration-300 hover:to-orange-600 transition-all duration-300 cursor-pointer'>View All</Link>
        </div>
